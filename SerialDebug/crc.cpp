...
//////////////////////////////////////////////////////////////////////////
// CRC16码表
static unsigned short const wCRC16_18005HTable[256] = { 
...
unsigned short CRC16(const char * pDataIn, int iLenIn)
{
	...
	for(int i = 0; i < iLenIn; i++)
	{
		...
		wResult = ((wResult >> 8) & 0xff) ^ wCRC16_18005HTable[wTableNo];
	}

	return wResult;
}

static unsigned long const crc_32_tab[] = { /* CRC polynomial 0xedb88320 */
